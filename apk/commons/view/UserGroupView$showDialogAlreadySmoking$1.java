...
final class UserGroupView$showDialogAlreadySmoking$1 implements SingleButtonCallback {
    final /* synthetic */ UserGroupView this$0;

    UserGroupView$showDialogAlreadySmoking$1(UserGroupView userGroupView) {
    ...
    public final void onClick(@NotNull MaterialDialog materialDialog, @NotNull DialogAction dialogAction) {
        ...
        if (access$getCallbacks$p != null) {
            UserGroup userGroup = new UserGroup(UserGroupView.GROUP_ID_TABACCO_OFFERS, null, true, null, null);

...
final class UserManager$requestPin$1<T> implements OnSubscribe<T> {
    final /* synthetic */ String $sanitizedMsn;
    final /* synthetic */ UserManager this$0;

    UserManager$requestPin$1(UserManager userManager, String str) {
        this.this$0 = userManager;
        this.$sanitizedMsn = str;
    }

    public final void call(Subscriber<? super String> subscriber) {
        Response execute = this.this$0.api.requestPin(this.$sanitizedMsn).execute();

...
final class StreamInactiveFragment$onCreateView$2$onBindViewHolder$1<TResult> implements OnSuccessListener<Uri> {
    final /* synthetic */ QuizHolder $viewHolder;
    final /* synthetic */ StreamInactiveFragment$onCreateView$2 this$0;

    StreamInactiveFragment$onCreateView$2$onBindViewHolder$1(StreamInactiveFragment$onCreateView$2 streamInactiveFragment$onCreateView$2, QuizHolder quizHolder) {
    ...
    public final void onSuccess(Uri uri) {
        ...
        if (activity != null) {
            Glide.with(activity).load(uri).centerCrop().into(this.$viewHolder.getMainPrizeImageView());
        }
    }
}

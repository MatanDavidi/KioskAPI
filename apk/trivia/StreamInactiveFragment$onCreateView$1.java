...
final class StreamInactiveFragment$onCreateView$1 implements OnClickListener {
    final /* synthetic */ StreamInactiveFragment this$0;

    StreamInactiveFragment$onCreateView$1(StreamInactiveFragment streamInactiveFragment) {
        this.this$0 = streamInactiveFragment;
    }

    public final void onClick(View view) {
        this.this$0.startActivity(DealiniLinks.INSTANCE.getPlayOnDealiniIntent(null));
    }
}
